...
# development environment. Then, it pushes this image to my 
# personal  repository # in DockerHub.
#
# NOTE: I had to change the repository from private to public in DockerHub due
# to the constrained on the number of private repositories allowed in 
# docker.io. 
#
# Author: Rubens Gomes
